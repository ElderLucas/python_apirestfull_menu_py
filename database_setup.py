...
class User(Base):
    ...
    name = Column(String(250), collation='utf8_bin', nullable=False)
    email = Column(String(250), collation='utf8_bin',nullable=False)
    picture = Column(String(250), collation='utf8_bin')
...
class MenuItem(Base):
    ...
    id = Column(Integer, primary_key = True)
    description = Column(String(250), collation='utf8_bin')
    price = Column(String(8), collation='utf8_bin')
    course = Column(String(250) ,collation='utf8_bin')
